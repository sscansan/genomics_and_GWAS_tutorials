...
\markdownRendererHeadingOne{Genomic\markdownRendererEmphasis{projects}tutorials}\markdownRendererInterblockSeparator
...
{}\markdownRendererImage{plot\markdownRendererUnderscore{}MDS}{Figures/goat\markdownRendererUnderscore{}mds\markdownRendererUnderscore{}2.png?raw=true}{Figures/goat_mds_2.png?raw=true}{multidimensional scaling of SNP data} <small>\markdownRendererStrongEmphasis{Multidimensional Scaling (MDS) Plot of a population of 4,653 Individuals from 169 Goat Breeds genotyped with 49,953 SNPs.}</small>\markdownRendererInterblockSeparator
...
{}\markdownRendererOlBeginTight
\markdownRendererOlItemWithNumber{2}a. Manhattan plot of a GWAS on dog population for deafness.\markdownRendererEmphasis{Data source}: \markdownRendererStrongEmphasis{Hayward et al.} (2020) https://doi.org/10.1371/journal.pone.0232900\markdownRendererOlItemEnd 
\markdownRendererOlEndTight \markdownRendererInterblockSeparator
{}\markdownRendererImage{plot\markdownRendererUnderscore{}manhattan}{Figures/manhattan\markdownRendererUnderscore{}dogs.png?raw=true}{Figures/manhattan_dogs.png?raw=true}{manhattan plot for dog deafness} \markdownRendererImage{plot\markdownRendererUnderscore{}manhattan}{Figures/manhattan\markdownRendererUnderscore{}filter\markdownRendererUnderscore{}acd.png?raw=true}{Figures/manhattan_filter_acd.png?raw=true}{manhattan plot for dog deafness} <small>Manhattan plots showing the genome wide association (GWA) between dog deafness and their genotype. The plot displays the genomic positions of single nucleotide polymorphisms (SNPs) across the genome on the x-axis, with the corresponding -log<sub>10</sub> transformed \markdownRendererEmphasis{P}-values indicating the strength of association with the trait on the y-axis. </small>\markdownRendererInterblockSeparator
{}\markdownRendererOlBeginTight
\markdownRendererOlItemWithNumber{2}b. Plot of the top significant SNPs identified by the above GWAS.\markdownRendererOlItemEnd 
\markdownRendererOlEndTight \markdownRendererInterblockSeparator
{}\markdownRendererImage{plot SNPs}{Figures/top\markdownRendererUnderscore{}SNPs\markdownRendererUnderscore{}comb.png?raw=true}{Figures/top_SNPs_comb.png?raw=true}{top SNPs plot for dog deafness}\markdownRendererInterblockSeparator
{}<img src="Figures/SNP\markdownRendererEmphasis{chr3}top.png" height="300px">\markdownRendererInterblockSeparator
{}\markdownRendererSectionBegin
