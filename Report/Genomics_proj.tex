...
\begin{figure}[!ht]
    \centering
    \subfloat[Corrplot]{\includegraphics[width = .49\linewidth]{../Figures/wheat_corrplot.png}\label{fig:wheat_corr}}
    \subfloat[Screeplot]{\includegraphics[width = .49\linewidth]{../Figures/wheat_exp_var_agro_data.png}\label{fig:wheat_scree_pheno}}
    \caption{%
...
\includepdf[pages=-,pagecommand={},width=\pagewidth]{build/output.pdf}
