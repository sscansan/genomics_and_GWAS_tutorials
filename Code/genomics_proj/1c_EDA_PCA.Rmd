...
ggsave("Figures/goat_mds.png", plot = mds_goat_var, height = 5, width = 9, dpi = 72)
...
ggsave("Figures/goat_mds_filtered.png", plot = mds_gooat_filtered, height = 5, width = 6, dpi = 300)
