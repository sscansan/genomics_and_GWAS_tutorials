...
```{r}
final <- (mds_goat + theme(panel.background = element_blank())) + (mds_gooat_filtered + theme(panel.background = element_blank()))
final <- final + theme(plot.background = element_blank())
ggsave("Figures/goat_mds_2.png", plot = final, height = 5, width = 11, dpi = 120)
```
