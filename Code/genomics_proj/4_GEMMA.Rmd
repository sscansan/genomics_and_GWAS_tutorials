...
GEMMA has the advantage that can use PLINK file directly, without conversions.
...
# run GEMMA
system(str_c("
gemma -bfile inputForGemma_ACD -k ./output/RelMat.cXX.txt -lmm 2 -o GWASresults.lmm"))
```
