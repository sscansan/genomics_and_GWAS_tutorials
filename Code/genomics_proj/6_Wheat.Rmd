...
pca_location <-
  ...
  geom_point(aes(color = as.factor(LOCATION)), alpha = .3) +
  ...
  geom_text(data = loadings_plot_df, aes(x = PC1*9, y = PC2*9, label = var), hjust = -0.1, vjust = -0.1, size = 3) +
  labs(
